    ...
    public class ReportContract
    {
        ...
        public string GenerateEthereumReport(ByteString configDigest, Report report)
        {
            ...
            var totalObserverCount =
                GenerateObserverIndex( report, out var observerIndex, out var observationsCount);
        ...
        private int GenerateObserverIndex(Report report, out List<byte> observerIndex,
            out List<byte> observationsCount)
        {
            var observersCount = report.Observers.Count;
            ...
            out List<byte> observations)
        {
            ...
            {
                int.TryParse(observation.Key, out var order);
